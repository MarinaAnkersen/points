...
class TeamModel(db.Model):
    ...
    def __init__(self, team_name, spi=None, off=None, defi=None,
                 goal_dif=None, pts=None, relegated=None,
                 make_from_playoffs=None, promoted=None, win_championship=None):
    ...
    def json(self):
        return {'id': self.id, 'team_name': self.team_name, 'spi': self.spi,
                'off': self.off, 'defi': self.defi, 'goal_dif': self.goal_dif,
                'pts': self.pts, 'relegated': self.relegated,
