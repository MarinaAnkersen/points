...
def seed_db():
    ...
    db.session.commit()
    db.session.add_all([MatchModel(match_id=1,match_date='2019-08-10', round_name='Week 1',
    ...
    MatchModel(match_id=2,match_date='2019-08-10', round_name='Week 2',
    ...
    MatchModel(match_id=3,match_date='2019-08-10', round_name='Week 2',
    first_squad_name='Manchester City', first_squad_score=0,
